...
int main(){
    ...
    #pragma omp target data map(to:rho[:total_size], rhou[:total_size], rhov[:total_size], E[:total_size], solid[:total_size]) \
    map(tofrom:rho_new[:total_size], rhou_new[:total_size], rhov_new[:total_size], E_new[:total_size])
    {
